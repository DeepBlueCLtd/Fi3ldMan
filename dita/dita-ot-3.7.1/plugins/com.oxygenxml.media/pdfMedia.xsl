...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="*[contains(@class,' topic/object ')][contains(@outputclass, 'iframe') or contains(@outputclass, 'audio') 
        or contains(@outputclass, 'video') or local-name() = 'video' or local-name() = 'audio']">
