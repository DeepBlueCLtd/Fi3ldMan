...
<!ENTITY % topicDefns 
  PUBLIC "-//OASIS//ENTITIES DITA 1.2 Topic Definitions//EN" 
         "../../../dita-ot-3.7.1/plugins/org.oasis-open.dita.v1_2/dtd/base/dtd/topicDefn.ent" 
>%topicDefns;

<!--                      Content elements common to map and topic -->
<!ENTITY % commonElements 
  PUBLIC "-//OASIS//ELEMENTS DITA 1.2 Common Elements//EN" 
         "../../../dita-ot-3.7.1/plugins/org.oasis-open.dita.v1_2/dtd/base/dtd/commonElements.mod" 
>%commonElements;

<!--                       MetaData Elements, plus indexterm       -->
<!ENTITY % metaXML 
  PUBLIC "-//OASIS//ELEMENTS DITA 1.2 Metadata//EN" 
         "../../../dita-ot-3.7.1/plugins/org.oasis-open.dita.v1_2/dtd/base/dtd/metaDecl.mod" 
>%metaXML;
