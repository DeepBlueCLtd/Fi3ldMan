...
--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:import xmlns:dita="http://dita-ot.sourceforge.net" href="plugin:com.oxygenxml.gsd:xsl/html5-gsd.xsl"/><xsl:import href="plugin:com.oxygenxml.highlight:xhtmlHighlight.xsl"/><xsl:import href="plugin:com.oxygenxml.media:xhtmlMedia.xsl"/>
